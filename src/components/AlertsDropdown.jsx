                            ...
                            {alerts
                                ...
                                .map((alert, index) => (
                                    ...
                                    >
                                        <Link
                                            to={alert.link || "#"}
                                            className={`block px-6 py-4 text-sm transition-all duration-200 border-b border-gray-100/50 last:border-b-0 group
                                             ${alert.isRead
                                                    ? "text-gray-400 hover:bg-gradient-to-r hover:from-gray-50 hover:to-gray-100"
                                                    : "text-gray-700 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50"}`}
                                        >
                                            <Motion.div whileHover={{ x: 4 }} transition={{ duration: 0.2 }}>
                                                <div className="flex items-start space-x-3">
                                                    <div
                                                        className={`w-2 h-2 rounded-full mt-2 flex-shrink-0 group-hover:scale-125 transition-transform duration-200 
                                                        ${alert.isRead
                                                                ? "bg-gray-300"
                                                    ...
                                                    <div className="flex-1">
                                                        <p
                                                            className={`font-medium transition-colors duration-200 ${alert.isRead ? "text-gray-500" : "text-gray-800 group-hover:text-gray-900"
                                                                }`}
                                                        >
                                                            {alert.message}
                                                        </p>
